var business1 = {
  ...
  description: "Casual, family-style eatery specializing in spicy fried chicken & Southern sides.",
  ...
  posts: [
    {
      ...
      description: "The 'Shaw: a spicy fried chicken sandwich between toasted brioche buns, topped with pickles",
    },
    {
    ...
    },
    {
      ...
      description: "Juicy chicken brined, floured, and fried in a secret blend of spices",
    },
    {
      image: "https://i.imgur.com/uMagHA9.jpg",
      title: "Hotville Chicken Sides",
      description: "Hotville Chicken's Cayenne Hot Sauce and bag of chips",
    },
  ],
};
...
var business2 = {
  ...
  posts: [
    ...
    },
    {
      ...
      description: "Handbags, headbands, books, and more to elevate your style",
    },
  ],
};
